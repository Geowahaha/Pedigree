...
const KNOWLEDGE_BASE: KnowledgeEntry[] = [
    // Greetings
    {
        ...
        response: {
            th: 'สวัสดีครับ! ผมคือ Petdegree AI พร้อมช่วยเหลือเรื่องสายพันธุ์สัตว์เลี้ยงของคุณครับ ถามอะไรได้เลย 🐾',
            en: 'Hello! I\'m Petdegree AI, here to help with your pet\'s pedigree and breeding needs. How can I assist you? 🐾'
        },
        intent: 'greeting'
    },
    // Good morning
...
function generateGreetingResponse(lang: 'th' | 'en'): BrainResponse {
    const greetings = {
        th: [
            'สวัสดีครับ! ผมคือ Petdegree AI พร้อมช่วยเหลือเรื่องสายพันธุ์สัตว์เลี้ยงครับ 🐾',
        ...
        en: [
            'Hello! I\'m Petdegree AI, here to help with pedigrees and breeding. 🐾',
