        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="text-center lg:text-left">
              <h3 className="text-2xl lg:text-3xl font-bold mb-2">Stay in the Loop</h3>
              <p className="text-white/60">Get updates on new features, breeding tips, and exclusive offers.</p>
            </div>
            <form onSubmit={handleSubscribe} className="flex w-full lg:w-auto gap-3">
              <input
                ...
                className="flex-1 lg:w-80 px-5 py-3.5 rounded-full bg-background/10 border border-background/20 text-secondary-foreground placeholder:text-secondary-foreground/40 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all"
                required
              />
              <button
                type="submit"
                className="px-6 py-3.5 rounded-full bg-accent text-white font-bold hover:bg-accent/90 transition-colors whitespace-nowrap shadow-lg hover:shadow-accent/20"
              >
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            <div className="flex items-center gap-3 mb-4 group cursor-pointer">
              ...
              <span className="text-xl font-bold">
                Pet<span className="text-accent">degree</span>
              </span>
            </div>
            <p className="text-white/60 mb-6 max-w-xs">
              The most elegant platform for breeders to preserve and celebrate their beloved companions' legacy.
            </p>
            {/* Social Links */}
            <div className="flex gap-3">
              {[
                ...
                <a
                  key={social.name}
                  href="#"
                  className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center text-white/60 hover:bg-[#8B9D83] hover:text-white transition-all"
