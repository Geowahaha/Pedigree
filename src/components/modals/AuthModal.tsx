            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className="col-span-2 flex items-center justify-center gap-2 py-3 rounded-xl border border-[#06C755]/30 hover:bg-[#06C755]/10 text-[#06C755] transition-colors bg-[#06C755]/5"
                >
