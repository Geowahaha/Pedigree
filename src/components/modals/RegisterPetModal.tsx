...
const RegisterPetModal: React.FC<RegisterPetModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  if (!user) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4">
        ...
        <div className="relative bg-[#1A1A1A] shadow-2xl w-screen h-[100dvh] max-w-none sm:w-full sm:max-w-xl sm:h-auto sm:max-h-[90vh] sm:rounded-2xl overflow-hidden border-0 sm:border sm:border-[#C5A059]/20">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4">
      ...
      {/* Modal - Dark Luxury Theme - Responsive */}
      <div className="relative bg-[#1A1A1A] shadow-2xl w-screen h-[100dvh] max-w-none sm:w-full sm:max-w-xl sm:h-auto sm:max-h-[90vh] sm:rounded-2xl overflow-hidden border-0 sm:border sm:border-[#C5A059]/20 flex flex-col">
        {/* Header */}
